...
# Reflection
Overall I think that this project didn't go that well and I'm disappointed that we didn't get to finish it on time. I think that the biggest issue that we ran into was the time constraint. originally, we planned on spending like 3-4 weeks on the CAD model and Code but we ended up not finishing the CAD and Code by the due date. If we had extra time, I think that we could've finished the project. One other problem that we had was that I think that both my partner and I were over ambitious with our project. The week that the project was due, we told Mr. Helmstetter that we think that we weren't going to finish the project so he suggested that we just scrap the color sensor and focus on building a working robot arm. We followed his advice and dropped the color sensor part and tried to focus on building the arm but we kept having minor issues turn into major time-consuming issues. At the end of the day, we didn't get to finish the project on time but we definietly learned many things from this project that we could use for future projects.
